...
class AdminAjaxController extends Controller {
    ...
    public function Croppie(){
        ...
        $image_path = Image::make(base_path("images/".$image_file_old));
        $image_width." ".$image_height;
       // dd($_GET);
        $image_path->crop(round($_GET['w']),round($_GET['h']),round($_GET["x"]),round($_GET["y"]))->save(base_path("images/".$image_file));
         if(isset($_GET["sv"])){
