                    ...
                    <form method="POST" action="{{ route('blog-create') }}" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-lg-8 col-md-12">
                                ...
                                @endif
                                <input type="hidden" name="date" value="{{ (isset($data) and $data->date !=Null )? $data->date : date("Y-m-d") }}">
                            ...
                            <div class="col-lg-4 col-md-12">
                                ...
                                <div class="form-group col-lg-12 col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            @endphp
                                            @php
                                            $cover = ($cover_image !="" ) ? "<img src=".$cover_image." alt=''>" : "";
                                            @endphp
                                ...
                                <div class="form-group col-lg-12 col-md-12">
                                    <div class="card">
                                        <div class="card-header card bg-secondary text-white">
                                            <b> Submit Record <span class="float-right"> <b>Updated Date : </b> {{ (isset($data) and $data->date != Null)?date("d M Y" , strtotime($data->date)) : "" }} </span></b>
                                        </div>
                                        <div class="card-body">
                                            <div class="form-group col-lg-12">
                                                <label for="example-date-input" class=" col-form-label font-weight-600">Updated Date</label>
                                                <div class="col-lg-12">
                                                    <input type="text" class="form-control" name="update_date" data-toggle="datepicker"></p>
                                                </div>
                                            </div>
