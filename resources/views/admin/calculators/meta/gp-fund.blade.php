          ...
          <div class="card mb-4 border-info">
              <div class="card-header bg-success">
                  <div class="d-flex justify-content-between align-items-center">
                      <div>
                            <h6 class="fs-17 font-weight-600 mb-0 text-white">GP Fund Calculator Meta</h6>
                        </div>
                      <div class="text-right">
                          <div class="actions">
                              <a href="{{ route('gp-fund-meta') }}" class="btn btn-sm btn-secondary float-right">GP Fund Calculator Meta</a>
                              <a href="{{ route('gp-fund') }}" class="btn btn-sm btn-info float-right mr-2">GP Fund Calculator</a>
                          </div>
                      </div>
                  </div>
              </div>
              <div class="card-body">
                ...
                @endif
                 <form method="POST" action="{{ route('gp-fund-meta') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
