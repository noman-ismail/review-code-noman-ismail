          ...
          <div class="card mb-4 border-info">
              <div class="card-header bg-success">
                  <div class="d-flex justify-content-between align-items-center">
                      <div>
                            <h6 class="fs-17 font-weight-600 mb-0 text-white">Pension Calculator Meta</h6>
                        </div>
                      <div class="text-right">
                          <div class="actions">
                              <a href="{{ route('pension-calculator-meta') }}" class="btn btn-sm btn-secondary float-right">Pension Calculator Meta</a>
                              <a href="{{ route('pension-calculator') }}" class="btn btn-sm btn-info float-right mr-2">Pension Calculator</a>
                          </div>
                      </div>
                  </div>
              </div>
              <div class="card-body">
                ...
                @endif
                 <form method="POST" action="{{ route('pension-calculator-meta') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
