  ...
  <div class="card mb-4 border-info">
    <div class="card-header bg-info text-white">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h6 class="fs-17 font-weight-600 mb-0">Add District User</h6>
        </div>{{-- 
    ...
    <form action="{{ route('add-d-user') }}" method="post" class="add-user-form">
      @csrf
      <div class="card-body">
    ...
    $(document).ready(function(){
      ...
      $('.submit').click(function(e){
          ...
          if(password == ''){
            ...
            $('._errpassword').text('Password contains minimum 4 characters.');
            eee++;              
          }else if(pass_length > 20 ){
            $('._errpassword').text('Password contains maximum 20 characters.');
            eee++;              
          }
          if(mobile == ''){
