        ...
        <div class="card-header bg-info text-white">
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="text-right">
              <a href="{{ route('about-cabinet') }}" class="btn btn-sm btn-success">About Cabinet</a>
              <a href="{{ route('about-cabinet-meta') }}" class="btn btn-sm btn-secondary">About Cabinet Meta</a>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          <form method="POST" action="{{ route('about-cabinet-meta') }}" enctype="multipart/form-data">
            @php
              $meta   = ($data->cabinet_meta  !="" )? json_decode($data->cabinet_meta , true) : array();
              ...
              <div class="col-lg-12 col-md-12">
                ...
                <div class="form-group col-lg-12 p-0">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control tcount" placeholder="meta title..." name="meta_title" value="{{ (isset($data) and !empty($data->cabinet_meta))?$meta['meta_title']:''}}" data-count="text">
                    <div class="input-group-append">
                      <span class="input-group-text count countshow">{{ (isset($data) and !empty($data->cabinet_meta))? strlen($meta['meta_title']):'0'}}</span>
                    </div>
                  </div>
                ...
                <div class="form-group col-lg-12 p-0">
                  ...
                  <div class="input-group">
                    <textarea class="form-control tcount" id="exampleFormControlTextarea1" rows="3" name="meta_description" data-count="text">{{ (isset($data) and !empty($data->cabinet_meta))?$meta['meta_description']:''}}</textarea>
                    <div class="input-group-append">
                      <span class="input-group-text count countshow">{{ (isset($data) and !empty($data->cabinet_meta))? strlen($meta['meta_description']):'0'}}</span>
                    </div>
                  </div>
                ...
                <div class="form-group col-md-12 p-0">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control tcount" data-count="tags" placeholder="TAG1 , TAG2 , TAG3" name="meta_tags" value="{{ (isset($data) and !empty($data->cabinet_meta))?$meta['meta_tags']:''}}">
                    <div class="input-group-append">
                      <span class="input-group-text count countshow">{{ (isset($data) and !empty($data->cabinet_meta))?count(explode(",",$meta['meta_tags'])):'0'}}</span>
                    </div>
                  </div>
                </div>
                <div class="form-group col-lg-12 p-0">
