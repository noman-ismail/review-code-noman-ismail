      ...
      <div class="card mb-4">
        <div class="card-header">
          <div class="d-flex justify-content-between align-items-center">
            <div>
              <h6 class="fs-17 font-weight-600 mb-0">Govt. Notifications Meta</h6>
            </div>
            <div class="text-right">
              <div class="actions">
                  ...
                  <a href="{{ route('download-list') }}" class="btn {{ Request::segment(2)=='download'  &&  Request::segment(3)==''  ? 'btn-inverse' : 'btn-info' }} pull-right">Notifications List</a>
        ...
        <div class="card-body">
          ...
          @endif
          <form method="POST" action="{{ route('district-notifications-meta') }}" enctype="multipart/form-data">
            @php
              $meta   = (!empty($data->notification_meta))? json_decode($data->notification_meta , true) : array();
              ...
              <div class="col-lg-10 col-md-12">
                ...
                <div class="form-group col-lg-12 p-0">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control tcount" placeholder="meta title..." name="meta_title" value="{{ (isset($data) and !empty($data->notification_meta))?$meta['meta_title']:''}}" data-count="text">
                    <div class="input-group-append">
                      <span class="input-group-text count countshow">{{ (isset($data) and !empty($data->notification_meta))? strlen($meta['meta_title']):'0'}}</span>
                    </div>
                  </div>
                </div>
                <div class="form-group col-lg-12 p-0">
                  ...
                  <div class="input-group">
                    <textarea class="form-control tcount" id="exampleFormControlTextarea1" rows="3" name="meta_description" data-count="text">{{ (isset($data) and !empty($data->notification_meta))?$meta['meta_description']:''}}</textarea>
                    <div class="input-group-append">
                      <span class="input-group-text count countshow">{{ (isset($data) and !empty($data->notification_meta))? strlen($meta['meta_description']):'0'}}</span>
                    </div>
                  </div>
                </div>
                <div class="form-group col-md-12 p-0">
                  ...
                  <div class="input-group">
                    <input type="text" class="form-control tcount" data-count="tags" placeholder="TAG1 , TAG2 , TAG3" name="meta_tags" value="{{ (isset($data) and !empty($data->notification_meta))?$meta['meta_tags']:''}}">
                    <div class="input-group-append">
                      <span class="input-group-text count countshow">{{ (isset($data) and !empty($data->notification_meta))?count(explode(",",$meta['meta_tags'])):'0'}}</span>
                    </div>
                  </div>
                </div>
                <div class="form-group col-lg-12 p-0">
