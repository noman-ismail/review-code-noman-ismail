    ...
    <div class="col-md-10 col-lg-12">
      <div class="card mb-4">
        ...
        <div class="card-body">
          ...
          @endif
          <form method="POST" action="{{ route('event-meta') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
              ...
              <div class="form-row col-lg-10">
                <div class="form-group col-lg-6 col-md-12">
                  <label class="font-weight-600">First Load Record Limit</label>
                  <div class="input-group">
                    <input type="number" class="form-control tcount" placeholder="" name="before_limit" value="{{ ($data !="")?$data->before_limit:''}}" >
                  </div>
                </div>
                <div class="form-group col-lg-6 col-md-12">
                  <label class="font-weight-600">After Click More Button Record Limit</label>
                  <div class="input-group">
                    <input type="number" class="form-control tcount" placeholder="" name="after_limit" value="{{ ($data !="")?$data->after_limit:''}}" >
                  </div>
                </div>
              </div>
              <div class="col-lg-12">
                <div class="form-group">
                  <label>Content</label>
                  <textarea rows="3" name="content" class="form-control oneditor" placeholder="Enter Details" value="">{{ isset($data )? $data->content:"" }}</textarea>
                </div>
              </div>
