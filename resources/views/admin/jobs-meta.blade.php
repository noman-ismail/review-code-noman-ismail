    ...
    <div class="col-md-10 col-lg-12">
      <div class="card mb-4">
          ...
          <div class="d-flex justify-content-between align-items-center">
            ...
            <div class="text-right">
              <div class="actions">
                ...
                <a href="{{url('/'.admin.'/jobs-meta')}}" class="btn {{ Request::segment(2)=='jobs-meta'  ? 'btn-inverse' : 'btn-info' }} pull-right">jobs Meta</a>
              </div>
            </div>
          </div>
        </div>
        <div class="card-body">
          ...
          @endif
          <form method="POST" action="{{ route('jobs-meta') }}" enctype="multipart/form-data">
            @csrf
            <div class="row">
