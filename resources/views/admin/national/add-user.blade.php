...
<div class="body-content">
  <div class="card mb-4 border-info">
    <div class="card-header bg-info text-white">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h6 class="fs-17 font-weight-600 mb-0">Add National User</h6>
        </div>{{-- 
    ...
    <form action="{{ route('add-n-user') }}" method="post" class="add-user-form">
      @csrf
      <div class="card-body">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <select name="panel_for" class="form-control" readonly>
  ...
  <script>
    ...
    $(document).ready(function(){
      var SMSformat = {
        name : "[[name]]",
        line1 : "You have been added as new National member.",
