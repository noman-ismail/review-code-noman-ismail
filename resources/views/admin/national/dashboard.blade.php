...
<div class="body-content">
    ...
    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-success card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          <h3 class="card-title fs-21 font-weight-bold">{{ $cabinet = DB::table('cabinets')->where(["dept_id" => $national , "national" => "yes"])->count() }}</h3>
        </div>
        <div class="card-footer p-3">
    ...
    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-info card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          <h3 class="card-title fs-21 font-weight-bold">{{ $users = DB::table('jobs')->where([["user_type" , "national"]])->count() }}</h3>
        </div>
        <div class="card-footer p-3">
    ...
    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-danger card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          <h3 class="card-title fs-21 font-weight-bold">{{ $event = DB::table('event')->where([["user_type" , "national" ]])->count() }}</h3>
        </div>
        <div class="card-footer p-3">
  ...
  <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-success card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          @php
            $news = DB::table('news')->where("user_type" , "national" )->count()
          @endphp
  ...
  <div class="header bg-white pb-4"> 
    ...
    @php
      ...
      $views = $Extra->adsViews("current_month" , "pakistan");
      $views_m = $Extra->adsViews("monthly" , "pakistan");
      $views_y = $Extra->adsViews("annually" , "pakistan");
    @endphp
