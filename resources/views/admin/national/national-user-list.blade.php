...
<div class="body-content">
  <div class="card mb-4 border-info">
    <div class="card-header bg-info text-white">
      <div class="d-flex justify-content-between align-items-center">
        <div>
          <h6 class="fs-17 font-weight-600 mb-0">National User List</h6>
        </div>
    ...
    <div class="card-body">
      <div class="row">
              ...
              @if(count($record) > 0)
                ...
                @foreach($record as $value)
                  <tr class="{{ ($value->status == "off")?"":"table-success" }}" >
                    ...
                    <td>
                      <a href="{{ route('national-u-list').'?id='.$value->id }}"><i class="fa fa-edit"></i></a>
                      <a href="{{ route('national-u-list').'?del='.$value->id }}" onclick="return confirm('Are You Sure?');"><i class="fa fa-trash"></i></a>
                    </td>
                  </tr>
                  @php
                    $i++;
        ...
        <div class="col-md-12">
          @if(isset($user))
            <form action="{{ route('national-u-list').'?id='.request('id')  }}" method="POST">
            @csrf
              <fieldset>
                ...
                <div class="row">
                  <div class="col-md-6 col-6">
                    ...
                    <div class="form-group">
                      ...
                      <select name="official_designation" class="form-control form-control-chosen">
  ...
  <script>
    $(document).ready(function(){
      var SMSformat = {
        name : "",
        line1 : "You have been updated as a National member.",
    ...
    $('.submit').click(function(e){
        e.preventDefault();
          var eee = 0;
          var designation = $('.national_name').val();
          if(designation == ''){
            $('._errnational_name').text('Copying Agency name field is required');
            eee++;
          }
          var action = 'copyist';
          var full_name = $('.user_name').val();
          var staff_designation = $('.designation').val();
