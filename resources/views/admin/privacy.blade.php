      ...
      <div class="col-lg-12">
          <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                @endif
                 <form method="post" action="/<?= admin ?>/privacy/store" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-8">
                          <input type="hidden" name="id" value="{{ isset($data)?$data->id:''}}"> 
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="content" rows="3" class="form-control oneditor" id="oneditor" rows="20"  aria-hidden="true">{{$data?$data->content:''}}</textarea>
