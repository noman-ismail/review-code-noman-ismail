    ...
    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-warning card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          <h3 class="card-title fs-21 font-weight-bold">{{ $users = DB::table('users')->where("province" , $province)->count() }}</h3>
        </div>
    ...
    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-success card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          <h3 class="card-title fs-21 font-weight-bold">{{ $districts = DB::table('cities')->where(["province" => $province])->count() }}</h3>
        </div>
        <div class="card-footer p-3">
    ...
    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-info card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          <h3 class="card-title fs-21 font-weight-bold">{{ $users = DB::table('jobs')->where([["province" , $province]])->count() }}</h3>
        </div>
        <div class="card-footer p-3">
    ...
    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-danger card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          <h3 class="card-title fs-21 font-weight-bold">{{ $event = DB::table('event')->where([["province" , $province]])->count() }}</h3>
        </div>
        <div class="card-footer p-3">
    ...
    <div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-warning card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          @php
          	 $Budget = DB::table("district_ledger")->where("province" , $province)->get()->sum("amount");
          @endphp
	...
	<div class="col-xl-2 col-lg-6 col-md-6 col-sm-6">
      <div class="card card-stats statistic-box">
        <div class="card-header card-header-success card-header-icon position-relative border-0 text-right px-3 py-0">
          ...
          @php
          	$news = DB::table('news')->where("province" , $province)->count()
          @endphp
