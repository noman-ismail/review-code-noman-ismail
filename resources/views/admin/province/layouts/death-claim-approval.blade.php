<div class="row">
	<div class="col-md-12">
		<div class="form-group">
			<label for="">Budget Amounts</label>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<input type="text" name="cash_date" class="form-control cash_deposit_date" data-toggle='datepicker' id='date-picker' autocomplete="off">
							</div>
							<div class="form-group">
								<label>Deposit Transaction Id</label>
								<input type="text" name="transaction_id" class="form-control cash_transaction_id">
							</div>
							<div class="form-group">
								<label>Cash Image</label>
					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="form-group">
								...
								<input type="text" name="trans_date" class="form-control trans_date" data-toggle='datepicker' id='date-picker' autocomplete="off">
							</div>
							<div class="form-group">
	...
	$(document).ready(function(){
		...
		$('.check_btn').click(function(){
			...
			if(title == "" || check_bank == '' || check_no == '' || check_date == ''){
		        ...
		        $.ajax({
		          url:baseURL+"death-claim-requests?status=check",
		          method: 'POST',
		          dataType: 'json',
		...
		$('.cash_btn').click(function(){
			...
			var transaction_id = $('.cash_transaction_id').val();
			var cash_img = $('.cash_img').val();
			if(title == "" || cash_bank == '' || cash_no == '' || cash_date == '' || transaction_id == ''){
				t.attr('disabled',false);
				$('.text-danger').html('Please fill the complete form.');
			}else{
		        $.ajax({
		          url:baseURL+"death-claim-requests?status=cash",
		          method: 'POST',
		          dataType: 'json',
		          ...
		          success:function(res){
		          	if(res == 'success'){
						...
						t.attr('disabled',false);
		          		$('.cash_image_erro').html(res.cash_image);
		          	}
		          }, error:function(e){
					t.attr('disabled',false);
		            alert('Failed to proceed payment method. Please refresh page and try again');
		...
		$('.bank_btn').click(function(){
			...
			if(title == "" || title2 == "" || ac1 == '' || ac2 == '' || to_bank == '' || from_bank == '' || trans_id == '' || trans_date == ''){
		        ...
		        $.ajax({
		          url:baseURL+"death-claim-requests?status=bank",
		          method: 'POST',
		          dataType: 'json',
