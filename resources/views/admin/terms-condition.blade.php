      ...
      <div class="col-md-12 col-lg-12">
          <div class="card mb-4">
              ...
              <div class="card-body">
                ...
                @endif
                 	<form method="post" action="/<?= admin ?>/terms/store" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-lg-8">
                          ...
                          <div class="form-group">
                              ...
                              <textarea name="content" class="form-control oneditor" id="oneditor" rows="15"  aria-hidden="true">{{$data?$data->content:''}}</textarea>
