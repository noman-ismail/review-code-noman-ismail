  ...
  <div class="message-content">
    ...
    <script>
      $(document).ready(function(){
        $('.fa-mobile-alt').addClass('fa-mobile').removeClass('fa-mobile-alt');
        $('.fa-futbol').addClass('fa-futbol-o').removeClass('fa-futbol');
        $('.fa-hand-paper').addClass('fa-hand-paper-o').removeClass('fa-hand-paper');
        $('.fa-apple-alt').addClass('fa-apple').removeClass('fa-apple-alt');
      ...
      if($(window).width() < 768){
          $("li.dropdown").click(function(){
            if($(this).find(".dropdown-content").hasClass("slideUp")){
                $(this).find(".icon-md i").addClass("fa-plus");
                $(this).find(".icon-md i").removeClass("fa-minus");
                ...
                $(this).find(".icon-md i").addClass("fa-minus");
                $(this).find(".icon-md i").removeClass("fa-plus");
      ...
      function showLoader(){
        var loader_url = '{{ asset('compress/loader-sm.gif') }}';
        $(".fb-page").css({"height":"500px","background":"white url('"+loader_url+"') no-repeat center center"});
      }
      function hideLoader(){
    ...
    <script>
      var choosen_url = '{{ asset('assets/style/chosen.css') }}';
      var choosen_js = '{{ asset('assets/js/chosen.js') }}';
      loadfiles(choosen_url,"css");
      loadfiles(choosen_js,"js");
